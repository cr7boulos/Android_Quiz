...
public static class OuyaSDK
{
    ...
    public class OuyaInput
    {
        ...
        //for the method GetButton(int button) I copied the code off of Github from the OUYA SDK page
        //The official Unity Download has not been updated to reflect the latest commits to the github source
        //https://github.com/ouya/ouya-sdk-examples/blob/master/Unity/OuyaSDK/Assets/Plugins/OuyaSDK.cs
